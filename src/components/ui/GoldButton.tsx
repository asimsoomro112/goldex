    ...
    return (
      <motion.button
        ...
        className={cn(
          ...
          variant === 'solid' && "bg-[linear-gradient(135deg,#FFD700_0%,#F5C400_30%,#D4AF37_60%,#FFE88A_100%)] text-dark-950 shadow-[0_4px_14px_rgba(212,175,55,0.39)] hover:shadow-[0_6px_20px_rgba(212,175,55,0.5)]",
